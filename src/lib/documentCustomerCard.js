 ...
 * Keep in sync with back/src/lib/documentCustomerCard.js
 */

export function resolveClientContact(client) {
    if (!client) {
...
export function resolveQuotationCustomerContact(quotation) {
...
export function renderDocumentCustomerCardHtml(contact, escapeHtml) {
    const e = escapeHtml;
